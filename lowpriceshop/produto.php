...
<button type="button" id="rmvToCartBtn">Remover do carrinho</button>
...
// JavaScript code to decrement clicks on the "Remover do carrinho" button
let rmvToCartBtn = document.getElementById('rmvToCartBtn');

rmvToCartBtn.addEventListener('click', function () {
    if (clickCount > 0) {
        clickCount--;
        let total = clickCount * <?php echo $product['precoProduto']; ?>;
        updateTotalDisplay(total);
